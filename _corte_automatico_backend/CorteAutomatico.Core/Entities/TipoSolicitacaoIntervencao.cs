...
[Index("Uuid", Name = "uk_tipo_solicitacao_intervencao_uuid", IsUnique = true)]
public partial class TipoSolicitacaoIntervencao: IEntity
{
    [Key]
    [Column("id")]
    ...
    [InverseProperty("TipoSolicitacaoIntervencao")]
